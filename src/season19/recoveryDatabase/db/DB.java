package season19.recoveryDatabase.db;
...
public class DB {
	...
	/**
	 * Método responsável por fazer o fechamento do recurso que armazena os dados retornados de uma instrução
	 * SQL, tratando possíveis exceções.
	 */
